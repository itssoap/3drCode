...
def blendr():
    a=np.array(Image.open('1.png').convert('RGBA'))
    b=np.array(Image.open('2.png').convert('RGBA'))
    c=np.array(Image.open('3.png').convert('RGBA'))
    ...
    new_image.convert('RGB').save('temp.png', "PNG")
